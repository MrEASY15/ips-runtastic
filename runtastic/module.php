...
//namespace Runtastic;
	class Runtastic extends IPSModule
	{
		...
		*/
	    ...
	    protected function RegisterProfileInteger(string $Name, string $Icon, string $Prefix, string $Suffix, float $MinValue, float $MaxValue, float $StepSize, integer $Digits)
		{
